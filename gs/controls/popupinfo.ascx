...
<ComponentArt:Dialog ID="dgPopup" OffsetX="10" OffsetY="10" AlignmentElement="" HeaderCssClass="dg5HeaderCss"
	ContentCssClass="dg5ContentCss" CssClass="gsp_dg5DialogCss gsp_ns" AllowDrag="false" CloseTransition="None"
	ShowTransition="None" AnimationDuration="1000" Title="Alert" runat="server" Width="303">
	<Header>
